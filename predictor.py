...
if __name__ == '__main__':
    ...
    parser.add_argument('-cp', dest='conv_padding', type=int, help="Convolutional padding mode ('same', or 'valid')")
    ...
    parser.add_argument('-rc', dest='recur_cells', nargs='*', type=int, help="List of 'rc' recurrent cell types ('GRU' or 'LSTM')")
    parser.add_argument('-rb', dest='recur_bidis', nargs='*', type=int, help="List of 'rc' flags indicating whether the layer is bidirectional ('True', 'False')")
    parser.add_argument('-rd', dest='recur_dropouts', type=float, help="List of 'rc' dropouts (between 0.0 and 1.0)")
    ...
    model_5 = custom_rnn_model(input_dim=13, # change to 13 if you would like to use MFCC features
                               ...
                               recur_layers=args.recur_layers, recur_units=args.recur_units, recur_cells=args.recur_ells, recur_bidis=args.recur_bidis, recur_batchnorms=[True]*args.recur_layers, recur_dropouts=args.recur_dropouts, \
